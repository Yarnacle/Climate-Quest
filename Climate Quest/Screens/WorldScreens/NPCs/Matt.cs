...
public class Matt: Npc
{
    public Matt(ScreenManager manager, SpriteBatch spriteBatch, World world) : base(manager, spriteBatch,
        Color.Tomato, world, new List<Tuple<Color, string>>()
        {
            ...
            Tuple.Create(Color.Aquamarine,"I've worked as a mechanic to serve as many people as possible. I have a masters degree in environmental science and understand the urgency of climate change."),
            Tuple.Create(Color.Aquamarine,"Additionally, I've pledged to never receive money from companies, only the people."),
